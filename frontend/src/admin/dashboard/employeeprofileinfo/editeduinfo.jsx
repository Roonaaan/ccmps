...
function Editeduinfo({ onClose }) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    await axios.delete(`https://ccmps-server-node.vercel.app/api/auth/delete-profileeduinfo/${editEmployeeId}/${deletedEduId}`);
    ...
    const handleAddEducation = async () => {
        try {
            ...
            const response = await axios.get("https://ccmps-server-node.vercel.app/api/auth/get-next-edu-id");
    ...
    const handleSave = async () => {
        try {
            ...
            await axios.post(`https://ccmps-server-node.vercel.app/api/auth/edit-profileeduinfo/${editEmployeeId}`, {
                school,
                yearGraduated,
                gradeLevel,
                degreeCourse
    ...
    const handleSaveNewData = async (newEdu) => {
        try {
            ...
            await axios.post(`https://ccmps-server-node.vercel.app/api/auth/add-profileeduinfo/${editEmployeeId}`, {
